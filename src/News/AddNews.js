...
function AddPost() {
  ...
  const Submit = (e) => {
    ...
    PushData("allnews", SendObj).then((r) => {
      console.log(r.path.pieces_[1]);
      var path = "allnews/" + r.path.pieces_[1];
      SendObj.Link = r.path.pieces_[1];
      SetData(path, SendObj);
    });
  };

  return (
    <div className="addpost">
      <h1 className="addpost_title">AddNews</h1>
      <input
        placeholder={"Title"}
        value={Title}
